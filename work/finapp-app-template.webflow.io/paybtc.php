...
// include 'percent.php';
// include 'ethprice.php';
// include 'ethaddress.php';
$invoice=$_SESSION['invoice'];


//address
$url='https://sandbox.cryptapi.io/btc/create/?address=tb1qxvmjd5wa6gha2hgzzfgqxhrqzj8kqdf3ttggj7&callback=http://payeth.php?invoice='.$invoice.'&nonce=randomstring';
//  Initiate curl
$ch = curl_init();
