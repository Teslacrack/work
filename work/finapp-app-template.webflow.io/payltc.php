...
// include 'percent.php';
// include 'naira.php';
// include 'ltcprice.php';
// include 'ltcaddress.php';

$invoice=$_SESSION['invoice'];

//address
$url='https://api.cryptapi.io/ltc/create/?address=MANLTUPnx2W5mgkJyX5VRsAYS432T5GGZk&callback=http://payltc.php?invoice='.$invoice.'&nonce=randomstring';
//  Initiate curl
$ch = curl_init();
...
$_SESSION['in_address']=$in_address;
