...
$paid= 'Paid';
 if (isset($_POST['submit']) && isset($_POST['invoice']) && !empty($_POST['invoice'])  ) {
    ...
    $url="https://api.cryptapi.io/trx/usdt/logs/?callback=http://ego.ezyro.com/work/finapp-app-template.webflow.io/paybtc.php/?invoice=$invoice";
    // echo urlencode($url);
    //  Initiate curl
    $ch = curl_init();
...
<input type="text" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" value="<?php echo @$wire;?>" disabled name="storage">
    ...
    <Br>
<div class="container">
    <form action="confirmusdt.php" method="POST" id="form">
